...
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="#">
    <img src="pictures/logo.png" width="40" height="40" alt="">
  </a>
  <div class="collapse navbar-collapse" id="navbarToggler">
      ...
      <a class="btn btn-outline-secondary mr-sm-2" href="/testing/registration" role="button">Зарегистрироваться</a>
  ...
  <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarToggler">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item"><a class="nav-link"  href="/testing/examination">Проверить знания</a></li>
        <li class="nav-item"><a class="nav-link"  href="/testing/statistics">Статистика</a></li>
        <li class="nav-item"><a class="nav-link"  href="/testing/about">О ресурсе</a></li>
      </ul>
      <a class="btn btn-outline-success mr-sm-2" href="/testing/profile" role="button">Профиль ${userSession.getLogin()}</a>
